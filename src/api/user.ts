...
/** 此处后端没有提供注释 POST /v1/user/listbypage */
export async function userListUserByPage(
  body: API.ListUserByPageRequest,
  options?: { [key: string]: any },
) {
  return request<API.ListUserByPageReply>('/v1/user/listbypage', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
